/**
 * Pure watch↔call matcher. No DB, no I/O — exhaustively unit testable. Lives in
 * shared/ so both the cron matcher (src/jobs) and the watch dry-run endpoint
 * (app/server) use one implementation.
 *
