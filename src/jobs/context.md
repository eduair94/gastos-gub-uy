...
- **Anomaly AI requests use a 60s timeout**, above the shared client's 30s default: complex multi-line contracts can legitimately take longer, and per-run partial errors remain pending for the hourly retry lane.
