 ...
 *
 * LA MITAD VERDADERA. La obra de fibra al hogar es tercerizada. Está en el pliego, no en el dicho.
...
const CONTENT: Record<Locale, AntelLado> = {
  es: {
    ...
    bajada: 'La cuadrilla que instala la fibra trabaja para una empresa contratista: está escrito en el pliego. El precio del dicho no cierra. La «tapa soldada» es un rubro real, el 210.80.50. Entra veinte veces en la planilla con la que Antel adjudicó la obra de todo el país por 95,5 millones de pesos. Aunque el contrato entero no comprara otra cosa, cada soldadura daría 4,8 millones.',
    ...
    portada: {
      cifras: [
        { valor: '6 de 164', etiqueta: 'llamados de obra de red de Antel que publican su adjudicatario', sub: 'Uno solo de esos seis es la obra de red en sí. Los otros cinco son parkas, calzado de trabajo, un depósito en Rivera y una digitalización de planos.' },
      ...
      parrafos: [
        'Esta pieza nace de la pregunta de un lector. La respuesta se parte en dos, porque las dos mitades no corren la misma suerte. La primera mitad es verdadera: la cuadrilla que instala la fibra trabaja para una empresa contratista. No hace falta creerle a nadie. Está en el pliego de condiciones que Antel publica.',
        'La segunda mitad no cierra. El rubro existe y tiene código. Entra veinte veces en la planilla de cotización con la que Antel adjudicó la obra. Con el total adjudicado y esa cantidad alcanza para descartar el precio. No hace falta suponer nada sobre el reparto de precios.',
        'En el camino apareció un dato que no estaba en la pregunta. Antel publicó 164 llamados de obra de red desde 2008. Uno solo dice quién construye la red.',
      ],
    },
    afirmacion: {
      titulo: 'El dicho, tal como llegó',
      dicho: 'Generalmente «la cuadrilla de Antel» es una empresa tercerizada que cobra unos 7 palos por tapa soldada… un negoción.',
      parrafos: [
        'El dicho tiene dos partes: si la cuadrilla es tercerizada, y si el precio es ese. La primera se verifica contra el pliego. La segunda se acota con el monto adjudicado, aunque el precio exacto no sea público.',
        'En Uruguay «un palo» es un millón de pesos. Así se lee acá. Si quien lo dijo manejaba otra escala, el registro público no alcanza para confirmarlo ni para desmentirlo. La sección «Lo que no se puede saber» explica por qué.',
      ],
    },
    tercerizada: {
      titulo: 'La primera mitad es verdadera, y está escrita',
      parrafos: [
        'En diciembre de 2025 Antel llamó a Licitación Pública 108693/2025. El objeto son los «trabajos de instalación de redes, ampliaciones y reposiciones de fibra óptica hasta el hogar, en todo el territorio nacional». El pliego de condiciones es público y ocupa 124 páginas. Ahí la cuadrilla no es una figura del habla. Es una categoría contractual.',
        'Antel resolvió la adjudicación el 25 de marzo de 2026. Ofertaron ocho empresas. Ganó el consorcio de ORITECNO S.A. y CIETEL S.A., por 95.508.755 pesos sin impuestos. El registro anota a cada una con la mitad, 47.754.377,50. No es un empate: las dos se presentaron como consorcio a constituirse, y el registro parte esa oferta única en dos.',
      ],
      clausulas: [
      ...
      matiz: 'El «generalmente» del dicho merece un freno. Antel también tiene planta externa propia, con funcionarios propios. 53 de sus llamados la nombran. Entre ellos hay compras de calzado de trabajo y de parkas de invierno «para los funcionarios de las Plantas Externas de todo el país». Conviven los dos modelos: Antel terceriza el despliegue y la ampliación de la red, y el mantenimiento aparece de las dos formas.',
    },
    aritmetica: {
      titulo: 'La segunda mitad: la cuenta que la desarma',
      parrafos: [
        'La «tapa soldada» no es una invención del dicho. Es el rubro 210.80.50 de la planilla de cotización. Soldar la tapa de una cámara es lo que suena: sellar la tapa de la boca de registro donde entran los cables.',
        'La planilla tiene 122 rubros. La empresa le pone precio unitario a cada uno. Antel fija las cantidades. El total de la planilla es lo que se compara entre oferentes y lo que se adjudica, según la cláusula 15.2. Las cantidades son estimadas y pueden variar durante la obra, según la cláusula 15.7.',
      ...
      veredicto: 'El contrato compra mucho más que esas veinte soldaduras. Incluye 90.000 metros de cable de 8 fibras tendido en poste, 33.000 metros de zanja a 70 centímetros, 950 columnas de 5,70 metros, 700 camaritas prefabricadas y 400 aperturas y cierres de caja de empalme. Son 122 rubros en total. La soldadura de tapa es uno de los renglones más chicos de la planilla: veinte unidades contra decenas de miles de metros. El precio del dicho no entra en el contrato ni forzando la cuenta a su límite.',
    },
    noSePuede: {
      titulo: 'Lo que no se puede saber, y por qué',
      parrafos: [
        'Ninguna pieza puede decir cuánto se paga por una tapa soldada. La planilla de cotización con los precios unitarios viaja dentro de la oferta de cada empresa. Las ofertas no se publican. El Estado publica el total.',
        'La distinción importa, porque separa lo verificable de lo opinable. Se puede afirmar que el precio del dicho no cabe en el contrato. No se puede afirmar cuál es el precio real, ni si es caro o barato contra el mercado.',
        'Queda un camino para cerrar esa brecha: pedir el cuadro comparativo de precios por acceso a la información pública. El documento existe, y el acta de adjudicación lo cita. Hoy no está en línea.',
      ],
    },
    cobertura: {
      titulo: 'El hallazgo que no estaba en la pregunta',
      parrafos: [
        'Fuimos a buscar cuánto le paga Antel a sus contratistas. Casi nunca se puede saber. Antel publica sus llamados. Rara vez publica quién es el adjudicatario.',
        'Antel tiene 7.582 registros en el corpus. 250 llevan el nombre de una empresa adjudicataria, el 3,3%. En OSE esa proporción es el 82,7%. En ANCAP es el 72,0%. No es una diferencia de formato ni un problema de nuestra ingesta: son los mismos archivos abiertos, el mismo portal y el mismo período.',
        'Acotado a la obra de red, el contraste es más marcado. Antel publicó 164 llamados de obra de red desde 2008: fibra óptica, planta externa, red de acceso y canalizaciones. Seis tienen adjudicatario publicado. De esos seis, uno solo es la obra de red: la licitación de fibra al hogar de 2025. Los otros cinco son ropa de trabajo, calzado, un depósito y una digitalización de planos.',
        'La plata está a la vista, sin nombre. Antel tiene 538 registros que publican un monto sin decir a quién se le adjudicó. Suman 11.641 millones de pesos, casi cinco veces los 2.426 millones que sí llevan nombre. Entre ellos hay una compra por excepción de 781 millones por «servicios de operación y mantenimiento, reparación». Hay también una licitación pública de 244 millones por «perfil técnico de planta externa», es decir, cuadrillas.',
      ],
      filas: [
    ...
    antecedente: {
      ...
      parrafos: [
        'Las licitaciones de fibra de Antel ya estuvieron bajo la lupa. En 2021 Antel adjudicó siete llamados de fibra al hogar repartidos por zonas. El Tribunal de Cuentas advirtió que los oferentes podían habérselos repartido. Derivó los antecedentes a la Comisión de Promoción y Defensa de la Competencia. La Comisión abrió una investigación de oficio y la cerró en diciembre de 2024, sin sanciones publicadas.',
        'Los nombres se repiten. Varias de las empresas que Brecha listó entonces volvieron a ofertar en 2026: Montelecnor, Electrosistemas, Ciemsa, SACEEM, Gofinal y Oritecno. La repetición no prueba nada por sí sola. Es un mercado chico. Son las empresas que hacen este trabajo en el país.',
        'En 2026 hubo ocho ofertas en un único llamado nacional. Ganó la más barata del comparativo. Eso dice el acta.',
      ],
    },
    limites: {
      ...
      puntos: [
        ...
        'Nombrar a ORITECNO, CIETEL o a cualquiera de los otros oferentes no implica ningún señalamiento. Figuran como proveedores del Estado en el registro oficial. La adjudicación de 2026 no tiene ninguna observación conocida.',
  ...
  en: {
    ...
    bajada: 'The crew that installs the fibre works for a contractor: it is written into the tender documents. The price in the saying does not add up. The "welded lid" is a real line item, code 210.80.50. It appears twenty times in the price schedule Antel used to award the nationwide works for 95.5 million pesos. Even if the whole contract bought nothing else, each weld would come to 4.8 million.',
    ...
    portada: {
      ...
      parrafos: [
        'This piece comes from a reader\'s question. The answer splits in two, because the two halves do not fare the same. The first half is true: the crew that installs the fibre works for a contractor. You need not take anyone\'s word for it. It is in the tender conditions Antel publishes.',
        'The second half does not add up. The line item exists and it has a code. It appears twenty times in the price schedule Antel awarded the works on. The awarded total and that quantity are enough to rule the price out. Nothing has to be assumed about how prices are split.',
        'Along the way a fact turned up that was not in the question. Antel has published 164 network-works tenders since 2008. Exactly one says who builds the network.',
      ],
    },
    afirmacion: {
      titulo: 'The saying, as it arrived',
      ...
      parrafos: [
        'The saying has two parts: whether the crew is outsourced, and whether the price is that. The first can be verified against the tender conditions. The second can be bounded with the awarded amount, even though the exact price is not public.',
        'In Uruguay "un palo" means one million pesos. That is how it is read here. If the speaker had another scale in mind, the public record cannot confirm it or deny it. The section "What cannot be known" explains why.',
      ],
    },
    tercerizada: {
      titulo: 'The first half is true, and it is in writing',
      parrafos: [
        'In December 2025 Antel called Public Tender 108693/2025. The subject is "network installation, extension and replacement works for fibre to the home, across the entire national territory". The tender conditions are public and run to 124 pages. There the crew is not a figure of speech. It is a contractual category.',
        'Antel resolved the award on 25 March 2026. Eight companies bid. The consortium of ORITECNO S.A. and CIETEL S.A. won, for 95,508,755 pesos before tax. The record lists each at half that, 47,754,377.50. It is not a tie: the two bid as a consortium to be formed, and the record splits that single bid in two.',
      ],
      clausulas: [
      ...
      matiz: 'The "generally" in the saying deserves a pause. Antel also has its own outside plant department, staffed by its own employees. 53 of its tenders name it. Among them are purchases of work boots and winter parkas "for the staff of the Outside Plant units across the country". Both models coexist: Antel outsources network rollout and extension, and maintenance appears in both forms.',
    },
    aritmetica: {
      titulo: 'The second half: the arithmetic that undoes it',
      parrafos: [
        'The "welded lid" is not an invention of the saying. It is line item 210.80.50 in the price schedule. Welding a chamber lid is what it sounds like: sealing the lid of the access chamber the cables run into.',
        'The schedule has 122 line items. The company prices each one. Antel sets the quantities. The schedule total is what gets compared between bidders and what gets awarded, per clause 15.2. Quantities are estimates and may vary during the works, per clause 15.7.',
      ...
      veredicto: 'The contract buys far more than those twenty welds. It includes 90,000 metres of 8-fibre cable strung on poles, 33,000 metres of trench at 70 centimetres, 950 poles of 5.70 metres, 700 prefabricated handholes and 400 splice-closure openings and closings. There are 122 line items in all. The lid weld is one of the smallest lines in the schedule: twenty units against tens of thousands of metres. The price in the saying does not fit in the contract even when the arithmetic is pushed to its limit.',
    },
    noSePuede: {
      titulo: 'What cannot be known, and why',
      parrafos: [
        'No piece can say what is paid for one welded lid. The priced schedule travels inside each company\'s bid. Bids are not published. The state publishes the total.',
        'The distinction matters, because it separates the verifiable from the arguable. One can state that the price in the saying does not fit in the contract. One cannot state what the real price is, or whether it is dear or cheap against the market.',
        'One route remains to close that gap: request the comparative price table under freedom-of-information law. The document exists, and the award resolution cites it. It is not online today.',
      ],
    },
    cobertura: {
      titulo: 'The finding that was not in the question',
      parrafos: [
        'We went to look for how much Antel pays its contractors. You almost never can. Antel publishes its tenders. It rarely publishes who the winner is.',
        'Antel has 7,582 records in the corpus. 250 carry a winning company\'s name, 3.3%. At OSE that share is 82.7%. At ANCAP it is 72.0%. This is not a formatting difference or a gap in our ingestion: same open files, same portal, same period.',
        'Narrowed to network works, the contrast is starker. Antel has published 164 network-works tenders since 2008: fibre optics, outside plant, access network and ducting. Six have a published winner. Of those six, exactly one is the network works itself: the 2025 fibre-to-the-home tender. The other five are workwear, boots, a depot and a drawings digitisation.',
        'The money is in plain sight, without a name. Antel has 538 records that publish an amount without saying who was awarded it. They add up to 11,641 million pesos, almost five times the 2,426 million that do carry a name. Among them is an exception purchase of 781 million for "operation and maintenance, repair services". There is also a public tender of 244 million for an "outside plant technical profile", that is, crews.',
      ],
      filas: [
        { ente: 'ANTEL', releases: '7,582', conAdj: '250', pct: '3.3%', destacar: true },
        { ente: 'OSE', releases: '9,072', conAdj: '7,500', pct: '82.7%' },
    ...
    antecedente: {
      ...
      parrafos: [
        'Antel\'s fibre tenders have come under scrutiny before. In 2021 Antel awarded seven fibre-to-the-home tenders split by geographic zone. The Court of Audit warned the bidders might have shared them out. It referred the file to the Competition Promotion and Defence Commission. The Commission opened an ex-officio investigation and closed it in December 2024, with no published sanctions.',
        'The names recur. Several of the firms Brecha listed then bid again in 2026: Montelecnor, Electrosistemas, Ciemsa, SACEEM, Gofinal and Oritecno. Recurrence proves nothing on its own. It is a small market. These are the firms that do this work in the country.',
        'In 2026 there were eight bids in a single national tender. The cheapest on the comparison won. That is what the award resolution says.',
      ],
    },
    limites: {
      titulo: 'The limits of this piece',
      puntos: [
        'No unit price is published here because none exists publicly. The arithmetic that undoes the saying uses only the awarded total and the line item\'s quantity in the schedule, both of which are public.',
        ...
        'Naming ORITECNO, CIETEL or any of the other bidders implies no accusation. They appear as state suppliers in the official record. The 2026 award carries no known objection.',
