...
| [routes/rss/anomalies.xml.get.ts](routes/rss/anomalies.xml.get.ts) + [utils/anomaly-rss.ts](utils/anomaly-rss.ts) | Public `GET /rss/anomalies.xml`: newest-first anomaly RSS, with the same severity/AI/category/rubro/buyer/supplier/product/year filters as the human list. Each full path+query is Redis-SWR cached. |
